...
export const animalTransferController = {
  ...
  approve: asyncHandler(async (req, res) => {
    ...
    res.json({
      success: true,
      data: await approveTransfer(await actorOf(req), req.params.id, note),
    });
  }),
  ...
  reject: asyncHandler(async (req, res) => {
    ...
    res.json({
      success: true,
      data: await rejectTransfer(await actorOf(req), req.params.id, reason),
    });
  }),
  ...
  receive: asyncHandler(async (req, res) => {
    ...
    res.json({
      success: true,
      data: await receiveTransfer(await actorOf(req), req.params.id, arriveAs),
    });
  }),
  ...
  cancel: asyncHandler(async (req, res) => {
    ...
    res.json({
      success: true,
      data: await cancelTransfer(await actorOf(req), req.params.id, reason),
    });
  }),
};
