...
const HISTORY: HistoryRow[] = [
  {
    id: "bk-h-lg-1", ref: "LG-100201", engineKind: "LAGOON", status: "COMPLETED",
    kioskId: "ksk_wayz_mountain", agentId: "usr_welcome_wayz",
    customerId: "cust_wayz_1", customerName: "Ahmed Saleh", customerPhone: "0599709998",
    productName: "Abra Trip", productNameAr: "رحلة عبرة",
    assetTypeId: "at_wayz_boat_abra", price: 90, minutesAgo: 260, durationMin: 30,
  },
  {
    id: "bk-h-lg-2", ref: "LG-100202", engineKind: "LAGOON", status: "COMPLETED",
    kioskId: "ksk_wayz_egypt", agentId: "usr_agent_egypt_wayz",
    customerId: "cust_wayz_2", customerName: "Sara Kamal", customerPhone: "0561234567",
    productName: "Gondola Trip", productNameAr: "رحلة جندول",
    assetTypeId: "at_wayz_boat_gondola", price: 120, minutesAgo: 195, durationMin: 25,
  },
  {
    id: "bk-h-lg-3", ref: "LG-100203", engineKind: "LAGOON", status: "CANCELLED",
    kioskId: "ksk_wayz_france", agentId: "usr_captain_wayz",
    customerId: "cust_wayz_3", customerName: "Nora Hassan", customerPhone: "0512223344",
    productName: "Dragon Boat", productNameAr: "قارب التنين",
    assetTypeId: "at_wayz_boat_dragon", price: 150, minutesAgo: 150, durationMin: 40,
    cancelledReason: "Wind over the safe limit for the dragon boat",
  },
  {
    id: "bk-h-lg-4", ref: "LG-100204", engineKind: "LAGOON", status: "DRAFT",
    kioskId: "ksk_wayz_mountain", agentId: "usr_welcome_wayz",
    customerId: "cust_wayz_2", customerName: "Sara Kamal", customerPhone: "0561234567",
    productName: "Feluka (small)", productNameAr: "فلوكة صغيرة",
    assetTypeId: "at_wayz_boat_feluka_small", price: 110, minutesAgo: 12, durationMin: 30,
  },
  {
    id: "bk-h-mb-1", ref: "MB-100205", engineKind: "MOBILITY", status: "COMPLETED",
    kioskId: "ksk_wayz_gate1", agentId: "usr_agent_gate1_wayz",
    customerId: "cust_wayz_1", customerName: "Ahmed Saleh", customerPhone: "0599709998",
    productName: "Single Scooter", productNameAr: "سكوتر فردي",
    assetTypeId: "at_wayz_veh_single_scooter", price: 60, minutesAgo: 300, durationMin: 60,
  },
  {
    id: "bk-h-mb-2", ref: "MB-100206", engineKind: "MOBILITY", status: "COMPLETED",
    kioskId: "ksk_wayz_gate2", agentId: "usr_agent_gate2_wayz",
    customerId: "cust_wayz_3", customerName: "Nora Hassan", customerPhone: "0512223344",
    productName: "Children's Stroller (Standard)", productNameAr: "عربة أطفال (عادية)",
    assetTypeId: "at_wayz_veh_stroller_std", price: 35, minutesAgo: 220, durationMin: 120,
  },
  {
    id: "bk-h-mb-3", ref: "MB-100207", engineKind: "MOBILITY", status: "DRAFT",
    kioskId: "ksk_wayz_gate1", agentId: "usr_agent_gate1_wayz",
    customerId: "cust_wayz_2", customerName: "Sara Kamal", customerPhone: "0561234567",
    productName: "Wheelchair", productNameAr: "كرسي متحرك",
    assetTypeId: "at_wayz_veh_wheelchair", price: 40, minutesAgo: 6, durationMin: 60,
  },
  {
    /*
     ...
     */
    id: "bk-h-mb-4", ref: "MB-100208", engineKind: "MOBILITY", status: "ACTIVE",
    kioskId: "ksk_wayz_ww_mob", agentId: "usr_agent_all_wayz",
    customerId: "cust_wayz_1", customerName: "Ahmed Saleh", customerPhone: "0599709998",
    productName: "Golf Cart", productNameAr: "عربة جولف",
    assetTypeId: "at_wayz_veh_cart", price: 180, minutesAgo: 35, durationMin: 120,
    holdsUnit: true,
  },
  {
    id: "bk-h-sd-1", ref: "SD-100209", engineKind: "SHOP_AND_DROP", status: "CANCELLED",
    kioskId: "ksk_wayz_morocco", agentId: "usr_agent_morocco_wayz",
    customerId: "cust_wayz_3", customerName: "Nora Hassan", customerPhone: "0512223344",
    productName: "Shop & Drop — S (1 bag)", productNameAr: "تسوق وأودع — صغير",
    assetTypeId: "at_wayz_cmp_s", price: 30, minutesAgo: 175, durationMin: 120,
...
export async function seedTradingHistory(): Promise<number> {
  ...
  for (const row of HISTORY) {
    ...
    const sessionKind = row.engineKind === "SHOP_AND_DROP" ? "STORAGE" : row.engineKind === "LAGOON" ? "ACTIVITY" : "RENTAL";
    ...
    if (unit) {
      await AssetUnit.updateOne({ _id: unit._id }, { $set: { status: "RENTED", currentBookingId: row.id } });
    }
