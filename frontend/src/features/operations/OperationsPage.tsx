...
export function OperationsPage() {
  ...
  return (
    <div data-testid="operations-page">
      <PageHeader helpId="operations" title={t('operations.title')} subtitle={t('operations.subtitle')} crumbs={[{ label: t('common:crumb.home'), to: '/dashboard' }, { label: t('common:crumb.operations') }]} />
      {isLoading ? <Spinner /> : (
        <DataTable
          ...
          empty={{ title: 'No active operations', message: 'Confirmed fulfilments appear here with live timers.' }}
        />
      )}
    </div>
  )
