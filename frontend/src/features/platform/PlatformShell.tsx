...
import { BookOpen, Building2, ChartNoAxesColumn, LayoutGrid, LogOut, Moon, Sun } from 'lucide-react'
...
const NAV = [
  { to: '/platform', end: true, icon: ChartNoAxesColumn, label: 'Overview', testId: 'nav-platform-overview' },
  { to: '/platform/organisations', icon: Building2, label: 'Organisations', testId: 'nav-platform-orgs' },
  { to: '/platform/reports', icon: LayoutGrid, label: 'Reports', testId: 'nav-platform-reports' },
  { to: '/platform/knowledge', icon: BookOpen, label: 'Knowledge', testId: 'nav-platform-knowledge' },
]
        ...
        <div className="mx-auto flex max-w-[1400px] items-center gap-4 px-5 py-3">
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <div className="text-[13px] font-semibold text-navy dark:text-dk-texthi">LockerFlow</div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    ...
                    isActive ? 'bg-brand/10 text-brand' : 'text-muted hover:bg-canvas dark:hover:bg-dk-elevated hover:text-navy dark:hover:text-dk-texthi',
                  )
                }
              >
                <item.icon size={15} />
          ...
          <div className="ms-auto flex items-center gap-2">
            ...
            <div className="hidden text-end leading-tight sm:block">
              <div className="text-[12px] font-medium text-navy dark:text-dk-texthi" data-testid="platform-who">
                {platform.name}
              </div>
