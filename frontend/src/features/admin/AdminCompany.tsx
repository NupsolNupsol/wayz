        ...
        <div className="flex flex-col gap-5">
          ...
          <Card className="p-4">
            <SectionTitle className="mb-1 flex items-center gap-2">
              <ToggleRight size={16} />
              {t('company.servicesYouOffer')}
            </SectionTitle>
            <p className="text-xs text-muted mb-3">{t('company.servicesNote')}</p>
                    ...
                    <span className="flex items-center gap-2">
                      {stat && (
                        <span className="text-[11px] text-muted">
                          {t('company.unitCount', { count: stat.units })}
                        </span>
                      )}
          ...
          <Card className="p-4">
            ...
            <p className="text-sm text-muted">{t('company.brandingNote')}</p>
