    ...
    <div data-testid="manager-settings">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <Card>
          ...
          <Field label={t('settings.tradingName')} required>
            <input
              className="lf-input"
              value={identity.name ?? ''}
          ...
          <div className="grid grid-cols-2 gap-x-4">
            <Field label={t('settings.crNumber')}>
              <input
                className="lf-input"
                value={identity.crNumber ?? ''}
                onChange={(e) => setIdentity({ ...identity, crNumber: e.target.value })}
              />
            </Field>
            <Field label={t('settings.vatNumber')}>
              <input
                ...
                onChange={(e) => setIdentity({ ...identity, vatNumber: e.target.value })}
              />
            </Field>
          </div>
          <Field label={t('common:label.address')}>
            <input
              className="lf-input"
          ...
          <div className="grid grid-cols-2 gap-x-4">
            <Field label={t('common:label.city')}>
              <input
                className="lf-input"
                value={company.city ?? ''}
            ...
            <Field label={t('common:label.country')}>
              <input
                className="lf-input"
          ...
          <div className="grid grid-cols-2 gap-x-4">
            ...
            <Field label={t('common:field.email')}>
              <input
                className="lf-input"
                value={company.email ?? ''}
        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-x-4">
              <Field label={t('settings.gracePeriod')} required hint={t('settings.graceHint')}>
                <input
                  ...
                  max={120}
                  className="lf-input"
                  value={ops.gracePeriodMin ?? '5'}
                  onChange={(e) => setOps({ ...ops, gracePeriodMin: e.target.value })}
              ...
              <Field label={t('settings.overtimeBlock')} hint={t('settings.overtimeHint')}>
                <input
                  ...
                  max={240}
                  className="lf-input"
                  value={ops.overtimeBlockMinutes ?? '60'}
                  onChange={(e) => setOps({ ...ops, overtimeBlockMinutes: e.target.value })}
                />
              </Field>
            </div>
            <div className="grid grid-cols-2 gap-x-4">
              <Field label={t('settings.warnBefore')} hint={t('settings.warnHint')}>
                <input
                  ...
                  max={120}
                  className="lf-input"
                  value={ops.expiryWarningMinutes ?? '15'}
                  onChange={(e) => setOps({ ...ops, expiryWarningMinutes: e.target.value })}
                />
              </Field>
            ...
            <div className="grid grid-cols-2 gap-x-4">
              <Field label={t('settings.currency')}>
                <input
                  ...
                  onChange={(e) => setIdentity({ ...identity, currency: e.target.value })}
                />
              </Field>
              <Field label={t('settings.vatRate')} hint={t('settings.vatHint')}>
                <input
                  ...
                  max={100}
                  className="lf-input"
                  value={identity.vatRatePct ?? '15'}
                  onChange={(e) => setIdentity({ ...identity, vatRatePct: e.target.value })}
                  data-testid="settings-vat"
                />
              </Field>
            </div>
          </Card>
          ...
          <Card>
            <SectionTitle className="mb-3 flex items-center gap-2">
              <ShieldCheck size={18} />
              {t('settings.verificationChannels')}
            </SectionTitle>
            ...
            <div className="flex items-start gap-2 rounded-lg bg-canvas dark:bg-dk-elevated p-3">
              ...
              <p className="text-xs text-muted">
                ...
                <span className="block mt-1">
                  {t('settings.fallbacksNote')}
                  <Badge tone="neutral">{t('settings.idDocument')}</Badge>{' '}
