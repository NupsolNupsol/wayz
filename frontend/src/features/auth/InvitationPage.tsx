...
const RULES: Rule[] = [
  ...
  {
    id: 'email',
    labelKey: 'invitation.ruleEmail',
    ok: (p, _c, email) => p.toLowerCase() !== email.toLowerCase(),
  },
            ...
            <div className="w-full max-w-[360px]">
              ...
              {!loading && loadError && (
                <div className="text-center py-4" data-testid="invitation-invalid">
                  ...
                  <h2 className="text-2xl font-extrabold text-navy dark:text-dk-texthi">
                    {t('invitation.dead')}
                  </h2>
              ...
              {!loading && invitation && (
                <form onSubmit={submit}>
                  ...
                  <div className="rounded-xl2 bg-canvas dark:bg-dk-elevated border border-line dark:border-dk-border px-4 py-3 mb-5">
                    ...
                    <p
                      className="text-sm font-medium text-navy dark:text-dk-text"
                  ...
                  <label className="lf-label" htmlFor="invite-password">
                  ...
                  <div className="flex items-center gap-2.5 mb-4">
                    ...
                    <button
                      ...
                      aria-label={
                        show ? t('invitation.hidePassword') : t('invitation.showPassword')
                      }
                  ...
                  <label className="lf-label" htmlFor="invite-confirm">
                  ...
                  <ul
                    className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5 mb-6"
                    data-testid="invitation-rules"
                  >
                    {checks.map((c) => (
                      <li
                        key={c.id}
                        className="flex items-center gap-2 text-xs"
                        data-testid={`invitation-rule-${c.id}`}
                      >
                        {c.passed ? (
                        ...
                        <span
                          className={clsx(c.passed ? 'text-navy dark:text-dk-text' : 'text-muted')}
                        >
                  ...
                  {error && (
                    <p
                      className="text-sm text-danger-strong mb-3"
                      role="alert"
