...
import { useCashierOverview, useOpenShift, useShift } from '@/hooks'
import { ApiError } from '@/api/client'
import { toast } from '@/state/toastStore'
import { money, waitedFor } from './cashierFormat'
...
export function CashierTill() {
  ...
  const { data, isLoading } = useCashierOverview()
  const { data: shift } = useShift()
  const openShift = useOpenShift()

  if (isLoading || !data) {
    return (
      <div data-testid="cashier-till">
  ...
  return (
    <div data-testid="cashier-till">
      <PageHeader
        ...
        helpId="cashier-till"
        actions={
          <Button variant="secondary" onClick={() => navigate('/cashier/queue')} data-testid="till-go-queue">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          onClick={() => navigate('/cashier/queue')}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start">
            ...
            {!d ? (
              ...
              <>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <Button variant="secondary" onClick={() => navigate('/cashier/drawer')} data-testid="till-go-drawer">
                    <Banknote size={16} />{t('till.movements')}</Button>
                  <Button variant="ghost" onClick={() => navigate('/cashier/shift')} data-testid="till-go-shift">
        ...
        <section>
          ...
          <Card className="p-4" data-testid="till-today">
            ...
            <Button variant="secondary" className="mt-4" onClick={() => navigate('/cashier/transactions')} data-testid="till-go-transactions">{t('till.everyTransaction')}<ArrowRight size={15} />
            </Button>
          </Card>
