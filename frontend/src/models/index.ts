...
export type BagItemStatus =
  'REGISTERED' | 'LABELLED' | 'STORED' | 'IN_TRANSIT' | 'RETRIEVED' | 'DELIVERED';
...
export type IncidentType =
  'MISSING_BAG' | 'DAMAGED_BAG' | 'WRONG_BAG' | 'LABEL_ISSUE' | 'ACCESS_ISSUE' | 'DAMAGE_ON_RETURN';
export type IncidentStatus =
  'REPORTED' | 'INVESTIGATING' | 'AWAITING_APPROVAL' | 'RESOLVED' | 'REJECTED';
