...
export const useManagerOverview = () =>
  useQuery({
    queryKey: qk.manager.overview,
    queryFn: managerApi.overview,
    refetchInterval: 30_000,
  });
export const useManagerLiveSessions = () =>
  useQuery({
    queryKey: qk.manager.live,
    queryFn: managerApi.liveSessions,
    refetchInterval: 20_000,
  });
export const useManagerIncidents = () =>
  useQuery({ queryKey: qk.manager.incidents, queryFn: managerApi.incidents });
export const useManagerShifts = () =>
  useQuery({ queryKey: qk.manager.shifts, queryFn: managerApi.shifts });
export const useManagerShift = (id: string | undefined) =>
  useQuery({
    queryKey: [...qk.manager.shifts, id ?? ''],
    queryFn: () => managerApi.shift(id!),
    enabled: !!id,
  });
export const useManagerStaff = () =>
  useQuery({ queryKey: qk.manager.staff, queryFn: managerApi.staff });
...
export const useManagerRental = (id: string | undefined) =>
  useQuery({
    queryKey: qk.manager.rental(id ?? ''),
    queryFn: () => managerApi.rentalDetail(id!),
    enabled: !!id,
  });
export const useManagerCustomers = () =>
  useQuery({ queryKey: qk.manager.customers, queryFn: managerApi.customers });
export const useManagerCustomer = (id: string | undefined) =>
  useQuery({
    queryKey: qk.manager.customer(id ?? ''),
    queryFn: () => managerApi.customerDetail(id!),
    enabled: !!id,
  });
export const useManagerOrg = () => useQuery({ queryKey: qk.manager.org, queryFn: managerApi.org });
export const useManagerPayments = () =>
  useQuery({ queryKey: qk.manager.payments, queryFn: managerApi.payments });
export const useManagerPricing = () =>
  useQuery({ queryKey: qk.manager.pricing, queryFn: managerApi.pricing });
export const useManagerSettings = () =>
  useQuery({ queryKey: qk.manager.settings, queryFn: managerApi.settings });
export const useManagerActivity = () =>
  useQuery({ queryKey: qk.manager.activity, queryFn: managerApi.activity });
...
export const useReportOccupancy = () =>
  useQuery({ queryKey: qk.manager.reportOccupancy, queryFn: managerApi.reportOccupancy });
...
export const useReportDiscounts = (r: { from?: string; to?: string }) =>
  useQuery({
    queryKey: qk.manager.reportDiscounts(r),
    queryFn: () => managerApi.reportDiscounts(r),
  });
...
export const useCreateSite = () =>
  useOrgMutation((v: Record<string, unknown>) => managerApi.createSite(v));
export const useUpdateSite = () =>
  useOrgMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateSite(v.id, v.patch)
  );
export const useCreateStation = () =>
  useOrgMutation((v: Record<string, unknown>) => managerApi.createStation(v));
export const useUpdateStation = () =>
  useOrgMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateStation(v.id, v.patch)
  );
export const useCreateKiosk = () =>
  useOrgMutation((v: Record<string, unknown>) => managerApi.createKiosk(v));
export const useUpdateKiosk = () =>
  useOrgMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateKiosk(v.id, v.patch)
  );
export const useRemoveKiosk = () => useOrgMutation((id: string) => managerApi.removeKiosk(id));
export const useCreateGate = () =>
  useOrgMutation((v: Record<string, unknown>) => managerApi.createGate(v));
export const useUpdateGate = () =>
  useOrgMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateGate(v.id, v.patch)
  );
...
export const useCreateStaff = () =>
  useStaffMutation((v: Record<string, unknown>) => managerApi.createStaff(v));
export const useUpdateStaff = () =>
  useStaffMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateStaff(v.id, v.patch)
  );
export const useResetStaffPassword = () =>
  useStaffMutation((v: { id: string; password: string }) =>
    managerApi.resetPassword(v.id, v.password)
  );
...
export const useCreateProduct = () =>
  usePricingMutation((v: Record<string, unknown>) => managerApi.createProduct(v));
export const useUpdateProduct = () =>
  usePricingMutation((v: { id: string; patch: Record<string, unknown> }) =>
    managerApi.updateProduct(v.id, v.patch)
  );
