...
export const accountingApi = {
  summary: (params: PeriodFilter) =>
    unwrap<AccountingSummary>(http.get('/accounting/summary', { params })),
  vatReturn: (params: PeriodFilter) =>
    unwrap<VatReturn>(http.get('/accounting/vat-return', { params })),
  ...
  transaction: (id: string) =>
    unwrap<TransactionDetail>(http.get(`/accounting/transactions/${id}`)),
  payments: (params: PaymentLedgerFilter) =>
    unwrap<LedgerPayment[]>(http.get('/accounting/payments', { params })),
  ...
  transactions: (params: TransactionFilter) =>
    unwrap<CardTransaction[]>(http.get('/accounting/transactions', { params })),
  transactionSummary: (params: TransactionFilter) =>
    unwrap<TransactionSummary>(http.get('/accounting/transactions/summary', { params })),
  reconciliation: (params: TransactionFilter) =>
    unwrap<Reconciliation>(http.get('/accounting/reconciliation', { params })),
