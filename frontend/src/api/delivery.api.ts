...
export const deliveryApi = {
  ...
  requestStorageRun: (bookingId: string) =>
    unwrap<Delivery>(http.post('/deliveries/storage-runs', { bookingId })),
  ...
  collect: (
    ...
    unwrap<{ collected: number; due: number }>(
      http.post(`/deliveries/courier/${id}/collect`, { splits })
    ),
};
