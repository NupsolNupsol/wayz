  ...
  return (
    <div ref={ref} className={clsx('relative', className)} data-testid={testId}>
      <button
        ...
        className={clsx(
          ...
          disabled
            ...
            : 'hover:border-brand/60 focus:border-brand focus:ring-[3px] focus:ring-brand/15',
      ...
      >
        ...
        <ChevronDown
          size={16}
          className={clsx('text-muted transition-transform shrink-0', open && 'rotate-180')}
        />
      </button>
              ...
              <div className="p-1.5 border-b border-line mb-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Search…"
                    className="w-full h-8 pl-8 pr-2 rounded-lg bg-canvas dark:bg-dk-elevated border border-line text-sm outline-none focus:border-brand"
                  />
                </div>
              </div>
            )}
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    o.value === value
                      ...
                      : 'text-navy dark:text-dk-text hover:bg-brand/5'
                  )}
                >
                  {o.icon}
