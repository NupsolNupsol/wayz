  ...
  return (
    ...
    >
      ...
      {placed.map((point) => {
        ...
        return (
          <button
            ...
            style={{
              left: `${(point.mapX as number) * 100}%`,
              top: `${(point.mapY as number) * 100}%`,
            }}
          >
            <span
              className={clsx(
                ...
                selectedId === point._id
                  ...
                  : 'ring-white/70 dark:ring-dk-bg/60',
                reached && 'opacity-60',
      ...
      <div
        ...
        style={{ boxShadow: 'inset 0 0 60px rgb(var(--shadow) / 0.12)' }}
      />
      ...
      <div className="absolute bottom-3 end-3 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wider text-muted/80 pointer-events-none">
        <span className="w-6 h-6 rounded-full border border-line dark:border-dk-border flex items-center justify-center">
          N
        </span>
      </div>
