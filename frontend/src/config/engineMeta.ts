...
/**
 * The activities that work live animals.
 *
 * Seven coded modules sharing one welfare model, so the handful of places that genuinely care
 * whether an animal is involved ask this rather than listing them again.
 */
export const ANIMAL_ACTIVITIES: EngineKind[] = [
  'HORSE_RIDING',
  'EQUESTRIAN_LESSON',
  'CAMEL_TOUR',
  'ANIMAL_CARE',
