...
export const useDeliveryOperation = (
  ...
  switch (transitionCode) {
    ...
    case 'TO_RELEASE_REQUESTED': {
      ...
      advance(
        ...
        DLV_RELEASE_REQUESTED,
        again
          ? 'Courier asked again — the previous code expired'
          : 'Courier at the kiosk requesting the bags'
      );
      break;
    }
    ...
    case 'TO_RELEASE_APPROVED': {
      ...
      advance(
        ...
        ctx,
        DLV_RELEASE_APPROVED,
        'The desk checked the courier and handed the bags over'
      );
      result.audits.push({
    ...
    case 'TO_PICKED_UP': {
      ...
      result.audits.push({
        ...
        detail: `${result.delivery.ref} · ${scanned.length} bag(s)`,
      });
      break;
    }
