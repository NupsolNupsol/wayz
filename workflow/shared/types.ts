...
export const ENGINE_BY_ASSET_KIND: Record<AssetKind, EngineKind> = Object.entries(
...
export type DeliveryOperator = (
  transitionCode: string,
  ctx: DeliveryContext
) => Promise<DeliveryOperationResult> | DeliveryOperationResult;
