...
export function getDeliveryWorkflow(
  assetKind: AssetKind = DEFAULT_DELIVERY_ASSET_KIND
): DeliveryWorkflowDef | null {
  return allDeliveryWorkflow[assetKind] ?? null;
}

export function getDeliveryValidator(
  assetKind: AssetKind = DEFAULT_DELIVERY_ASSET_KIND
): DeliveryValidator | null {
  return dlvValidators[assetKind] ?? null;
}

export function getDeliveryOperator(
  assetKind: AssetKind = DEFAULT_DELIVERY_ASSET_KIND
): DeliveryOperator | null {
